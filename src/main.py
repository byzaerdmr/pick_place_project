...
def main():
    ...
    try:
        ...
        view_mode = 0  # 0: main view, 1: side view, 2: fps mode
        ...
        while p.isConnected():
            ...
            if ord(' ') in keys and keys[ord(' ')] & p.KEY_WAS_TRIGGERED:
                ...
                if view_mode == 0:
                    world.camera_yaw = 10
                    p.resetDebugVisualizerCamera(1, world.camera_yaw, -40, [0.65, 0, 0.75])
                elif view_mode == 1:
                    world.camera_yaw = 90
                    p.resetDebugVisualizerCamera(1.2, world.camera_yaw, -30, [0.4, 0, 0.5])
